...
T147 = (1-params(2))*1/params(16)*(params(7)-1)/params(7);
T153 = (y(15)/y(1))^(1-params(8));
T163 = y(1)*y(18)/y(18);
T217 = exp(params(17)/2*(T67-params(19))^2);
T227 = exp(params(18)/2*(T163-params(19))^2);
T240 = getPowerDeriv(y(16)/y(1),params(2),1);
T251 = getPowerDeriv(y(15)/(y(1)*y(10)),1-params(8),1);
T257 = getPowerDeriv(y(1)*y(10)/y(15),params(8),1);
T266 = getPowerDeriv(y(15)/y(1),1-params(8),1);
T304 = getPowerDeriv(y(2)/y(7),1-params(10),1);
T336 = getPowerDeriv(T115,(-params(4)),1);
T383 = T336*(-(y(15)*T111*getPowerDeriv(y(14),1+params(3),1)));
lhs =y(1);
...
residual(17)= lhs-rhs;
lhs =y(17);
rhs =y(11)*(params(2)*y(8)*y(1)*(params(7)-1)/(params(7)*params(16)*y(16))+(1-params(5))*y(17));
residual(18)= lhs-rhs;
lhs =log(y(19));
rhs =params(14)*x(1)+log(y(19))*params(12)-params(13)*log(y(27));
residual(19)= lhs-rhs;
lhs =y(20);
...
if nargout >= 2,
  ...
  g1(7,2)=y(19)*y(4)*params(15)*params(10)*1/y(7)*T304;
  g1(7,4)=T62*y(19)*params(15)*params(10);
  g1(7,7)=y(19)*y(4)*params(15)*params(10)*T304*(-y(2))/(y(7)*y(7));
  ...
  g1(8,8)=(-1);
  g1(8,9)=1;
  g1(9,1)=(-(T86*(-y(16))/(y(1)*y(1))*T240));
  g1(9,8)=1;
  g1(9,14)=(-(T83*getPowerDeriv(y(14),1-params(2),1)));
  g1(9,16)=(-(T86*T240*1/y(1)));
  g1(10,7)=(-1);
  g1(10,9)=1;
  g1(10,10)=(-1);
  g1(10,18)=(-(1+log(y(25))));
  ...
  g1(11,11)=1;
  g1(12,1)=(-((-y(13))*params(8)*(-(y(10)*y(15)))/(y(1)*y(10)*y(1)*y(10))*T251));
  g1(12,10)=(-(T336+(-y(13))*params(8)*T251*(-(y(1)*y(15)))/(y(1)*y(10)*y(1)*y(10))));
  g1(12,12)=1;
  g1(12,13)=(-(T124*(-params(8))));
  g1(12,14)=(-T383);
  g1(12,15)=(-(T336*(-(T111*T113))+(-y(13))*params(8)*T251*1/(y(1)*y(10))));
  g1(13,1)=(-(params(1)*(1-params(8))*(T131*y(13)*getPowerDeriv(y(1),(-params(4)),1)+T129*y(10)/y(15)*T257)));
  g1(13,10)=(-(params(1)*(1-params(8))*T129*T257*y(1)/y(15)+T113*T111*T336));
  g1(13,13)=1-params(1)*(1-params(8))*T104*T131;
  g1(13,14)=(-(T111*T116*getPowerDeriv(y(14),1+params(3),1)+T113*T111*T383));
  g1(13,15)=(-(params(1)*(1-params(8))*T129*T257*(-(y(1)*y(10)))/(y(15)*y(15))+T113*T111*T336*(-(T111*T113))));
  g1(14,9)=(-(T147*1/y(14)));
  g1(14,10)=T142*T336;
  g1(14,12)=T116*y(15)*params(6)*y(14)^params(3)*(-1)/(y(12)*y(12));
  g1(14,14)=T142*T383+T116*1/y(12)*y(15)*params(6)*getPowerDeriv(y(14),params(3),1)-T147*(-y(9))/(y(14)*y(14));
  g1(14,15)=T142*T336*(-(T111*T113))+T116*1/y(12)*params(6)*y(14)^params(3);
  g1(15,1)=(-(y(10)^params(8)*(-y(15))/(y(1)*y(1))*T266));
  g1(15,10)=(-(T153*getPowerDeriv(y(10),params(8),1)));
  g1(15,15)=1-y(10)^params(8)*T266*1/y(1);
  ...
  g1(18,1)=(-(y(11)*params(2)*y(8)*(params(7)-1)/(params(7)*params(16)*y(16))));
  g1(18,8)=(-(y(11)*params(2)*y(1)*(params(7)-1)/(params(7)*params(16)*y(16))));
  g1(18,11)=(-(params(2)*y(8)*y(1)*(params(7)-1)/(params(7)*params(16)*y(16))+(1-params(5))*y(17)));
  g1(18,16)=(-(y(11)*(-(params(2)*y(8)*y(1)*(params(7)-1)*params(7)*params(16)))/(params(7)*params(16)*y(16)*params(7)*params(16)*y(16))));
  g1(18,17)=1-y(11)*(1-params(5));
  g1(19,19)=1/y(19)-params(12)*1/y(19);
  g1(19,27)=params(13)*1/y(27);
  g1(20,2)=(-y(4));
  g1(20,3)=(-y(4));
  g1(20,4)=(-(y(2)+y(3)-1));
  g1(20,5)=(-1);
