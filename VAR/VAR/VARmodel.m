...
%% Listwise deletion of missing variables
%  Added by Patrick Moran. Same method as stata
%  TODO: send a msg to the guy who wrote this VAR code, so he can add this
%===============================================
ismissing = max(isnan([Y, X]),[],2);
Y = Y(~ismissing,:);
X = X(~ismissing,:);
