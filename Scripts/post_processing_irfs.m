...
A_lead = cumsum(oo_.irfs.g_epsilon_n);
A = zeros(size(A_lead));
A(2:end) = A_lead(1:end-1);
oo_.irfs.A_epsilon_n = A;

% Modify the detrended variables
oo_.irfs.Z_epsilon_n = oo_.irfs.ZD_epsilon_n + A;
oo_.irfs.V_epsilon_n = oo_.irfs.VD_epsilon_n + A;
oo_.irfs.N_epsilon_n = oo_.irfs.ND_epsilon_n + A;
oo_.irfs.Y_epsilon_n = oo_.irfs.YD_epsilon_n + A;
oo_.irfs.C_epsilon_n = oo_.irfs.CD_epsilon_n + A;
oo_.irfs.K_epsilon_n = oo_.irfs.KD_epsilon_n + A;
oo_.irfs.I_epsilon_n = oo_.irfs.ID_epsilon_n + A;
oo_.irfs.S_epsilon_n = oo_.irfs.SD_epsilon_n + A;
oo_.irfs.X_epsilon_n = oo_.irfs.XD_epsilon_n + A;
oo_.irfs.R_epsilon_n = oo_.irfs.RD_epsilon_n + A;
oo_.irfs.UC_epsilon_n = oo_.irfs.UCD_epsilon_n + A;
oo_.irfs.mu_epsilon_n = oo_.irfs.muD_epsilon_n + A;
oo_.irfs.Gamma_epsilon_n = oo_.irfs.GammaD_epsilon_n + A;
